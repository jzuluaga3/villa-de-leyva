...
export default function ThingsToDo() {
  const restaurants = {
    breakfast: [
      ...
      },
      {
        ...
        note: '(Solo sábados hasta las 3 PM)',
        rating: 4.4,
        reviewCount: 1642,
      },
      {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <section className="bg-white border-b border-gray-200 py-6 md:py-10 px-4 md:px-6 lg:px-8">
      ...
      {/* Restaurants Section */}
      <section id="restaurants" className="py-6 md:py-10 px-4 md:px-6 lg:px-8">
      ...
      {/* Activities Section */}
      <section id="activities" className="py-6 md:py-10 px-4 md:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
